...
namespace MeshTools.BuildLogger
{
    public class MeshBuildLogger : ILogger
    {
        public static readonly string AssemblyPath = Path.GetFullPath(typeof(MeshBuildLogger).Assembly.Location);
