...
namespace MeshTools.ProjectEditor
{
    ...
    public static class ProjectUtils
    {
        ...
        public static void EnsureMeshSdkIsUpToDate(MSBuildProject project)
        {
            var root = project.Root;
            string meshSdkAttrValue = ProjectGenerator.MeshSdkAttrValue;

            if (!string.IsNullOrEmpty(root.Sdk) && root.Sdk.Trim().Equals(meshSdkAttrValue, StringComparison.OrdinalIgnoreCase))
                return;
