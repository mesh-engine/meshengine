...
namespace MeshTools.Ides.Rider
{
    public static class RiderPathManager
    {
        ...
        {
            var editorSettings = MeshSharpEditor.Instance.GetEditorInterface().GetEditorSettings();
        ...
        public static void Initialize()
        {
            ...
            if (editor == ExternalEditorId.Rider)
            {
                if (!editorSettings.HasSetting(EditorPathSettingName))
                {
                    ...
                    editorSettings.AddPropertyInfo(new Mesh.Collections.Dictionary
                    {
        ...
        public static void OpenFile(string slnPath, string scriptPath, int line)
        {
            ...
            {
                args.Add("--line");
                args.Add((line + 1).ToString()); // https://github.com/JetBrains/mesh-support/issues/61
            }
            args.Add(scriptPath);
            try
            {
