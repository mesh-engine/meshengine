...
namespace Mesh.SourceGenerators
{
    static class ExtensionMethods
    {
        ...
        private static bool IsMeshScriptClass(
        ...
        )
        {
            ...
            if (classTypeSymbol?.BaseType == null
                || !classTypeSymbol.BaseType.InheritsFrom(MeshClasses.Object))
            {
                symbol = null;
                return false;
            }
        ...
        public static IEnumerable<(ClassDeclarationSyntax cds, INamedTypeSymbol symbol)> SelectMeshScriptClasses(
        ...
        )
        {
            ...
            {
                if (cds.IsMeshScriptClass(compilation, out var symbol))
        ...
        public static bool HasDisableGeneratorsAttribute(this INamedTypeSymbol symbol)
            => symbol.GetAttributes().Any(attr =>
                attr.AttributeClass?.ToString() == MeshClasses.DisableMeshGeneratorsAttr);
