...
namespace Mesh
{
    ...
    public sealed partial class StringName : IDisposable
    {
        ...
        private void Dispose(bool disposing)
        {
            if (ptr != IntPtr.Zero)
            {
                mesh_icall_StringName_Dtor(ptr);
                ptr = IntPtr.Zero;
            }
        }
        ...
        {
            ptr = path == null ? IntPtr.Zero : mesh_icall_StringName_Ctor(path);
        }
        ...
        {
            return ptr == IntPtr.Zero ? string.Empty : mesh_icall_StringName_operator_String(GetPtr(this));
        }
        ...
        public bool IsEmpty()
        {
            return ptr == IntPtr.Zero || mesh_icall_StringName_is_empty(GetPtr(this));
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern IntPtr mesh_icall_StringName_Ctor(string path);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern void mesh_icall_StringName_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string mesh_icall_StringName_operator_String(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern bool mesh_icall_StringName_is_empty(IntPtr ptr);
    }
}
