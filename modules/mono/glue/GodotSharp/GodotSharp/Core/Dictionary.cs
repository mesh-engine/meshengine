...
namespace Mesh.Collections
{
    internal class DictionarySafeHandle : SafeHandle
    {
        ...
        {
            Dictionary.mesh_icall_Dictionary_Dtor(handle);
            return true;
        }
    }

    /// <summary>
    /// Wrapper around Mesh's Dictionary class, a dictionary of Variant
    ...
    public class Dictionary : IDictionary, IDisposable
    {
        ...
        public Dictionary()
        {
            _safeHandle = new DictionarySafeHandle(mesh_icall_Dictionary_Ctor());
        }
        ...
        /// <returns>A new Mesh Dictionary.</returns>
        ...
        {
            return new Dictionary(mesh_icall_Dictionary_Duplicate(GetPtr(), deep));
        }
        ...
        public ICollection Keys
        {
            get
            {
                IntPtr handle = mesh_icall_Dictionary_Keys(GetPtr());
        ...
        public ICollection Values
        {
            get
            {
                IntPtr handle = mesh_icall_Dictionary_Values(GetPtr());
                return new Array(new ArraySafeHandle(handle));
            }
        }
        ...
        {
            int count = mesh_icall_Dictionary_KeyValuePairs(GetPtr(), out IntPtr keysHandle, out IntPtr valuesHandle);
        ...
        {
            get => mesh_icall_Dictionary_GetValue(GetPtr(), key);
            set => mesh_icall_Dictionary_SetValue(GetPtr(), key, value);
        }
        ...
        public void Add(object key, object value) => mesh_icall_Dictionary_Add(GetPtr(), key, value);

        /// <summary>
        /// Erases all items from this <see cref="Dictionary"/>.
        /// </summary>
        public void Clear() => mesh_icall_Dictionary_Clear(GetPtr());
        ...
        public bool Contains(object key) => mesh_icall_Dictionary_ContainsKey(GetPtr(), key);
        ...
        public void Remove(object key) => mesh_icall_Dictionary_RemoveKey(GetPtr(), key);
        ...
        public int Count => mesh_icall_Dictionary_Count(GetPtr());
        ...
        private class DictionaryEnumerator : IDictionaryEnumerator
        {
            ...
            {
                _dirty = false;
                mesh_icall_Dictionary_KeyValuePairAt(_dictionary.GetPtr(), _index, out object key, out object value);
        ...
        {
            return mesh_icall_Dictionary_ToString(GetPtr());
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr mesh_icall_Dictionary_Ctor();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Dictionary_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object mesh_icall_Dictionary_GetValue(IntPtr ptr, object key);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object mesh_icall_Dictionary_GetValue_Generic(IntPtr ptr, object key, int valTypeEncoding, IntPtr valTypeClass);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Dictionary_SetValue(IntPtr ptr, object key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr mesh_icall_Dictionary_Keys(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr mesh_icall_Dictionary_Values(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int mesh_icall_Dictionary_Count(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int mesh_icall_Dictionary_KeyValuePairs(IntPtr ptr, out IntPtr keys, out IntPtr values);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Dictionary_KeyValuePairAt(IntPtr ptr, int index, out object key, out object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Dictionary_Add(IntPtr ptr, object key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Dictionary_Clear(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_Dictionary_Contains(IntPtr ptr, object key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_Dictionary_ContainsKey(IntPtr ptr, object key);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr mesh_icall_Dictionary_Duplicate(IntPtr ptr, bool deep);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_Dictionary_RemoveKey(IntPtr ptr, object key);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_Dictionary_Remove(IntPtr ptr, object key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_Dictionary_TryGetValue(IntPtr ptr, object key, out object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_Dictionary_TryGetValue_Generic(IntPtr ptr, object key, out object value, int valTypeEncoding, IntPtr valTypeClass);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Dictionary_Generic_GetValueTypeInfo(Type valueType, out int valTypeEncoding, out IntPtr valTypeClass);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string mesh_icall_Dictionary_ToString(IntPtr ptr);
    }

    /// <summary>
    /// Typed wrapper around Mesh's Dictionary class, a dictionary of Variant
    /// typed elements allocated in the engine in C++. Useful when
    ...
    public class Dictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        static Dictionary()
        {
            Dictionary.mesh_icall_Dictionary_Generic_GetValueTypeInfo(typeof(TValue), out valTypeEncoding, out valTypeClass);
        }
        ...
        public Dictionary(IDictionary<TKey, TValue> dictionary)
        {
            ...
            IntPtr meshDictionaryPtr = GetPtr();

            foreach (KeyValuePair<TKey, TValue> entry in dictionary)
            {
                Dictionary.mesh_icall_Dictionary_Add(meshDictionaryPtr, entry.Key, entry.Value);
            }
        }
        ...
        {
            get { return (TValue)Dictionary.mesh_icall_Dictionary_GetValue_Generic(_objectDict.GetPtr(), key, valTypeEncoding, valTypeClass); }
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                IntPtr handle = Dictionary.mesh_icall_Dictionary_Keys(_objectDict.GetPtr());
        ...
        public ICollection<TValue> Values
        {
            get
            {
                IntPtr handle = Dictionary.mesh_icall_Dictionary_Values(_objectDict.GetPtr());
        ...
        {
            Dictionary.mesh_icall_Dictionary_KeyValuePairAt(GetPtr(), index, out object key, out object value);
        ...
        {
            return Dictionary.mesh_icall_Dictionary_RemoveKey(GetPtr(), key);
        }
        ...
        {
            bool found = Dictionary.mesh_icall_Dictionary_TryGetValue_Generic(GetPtr(), key, out object retValue, valTypeEncoding, valTypeClass);
        ...
        {
            return Dictionary.mesh_icall_Dictionary_Remove(GetPtr(), item.Key, item.Value);
            ;
        }
