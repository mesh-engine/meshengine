...
namespace Mesh
{
    ...
    public sealed partial class NodePath : IDisposable
    {
        ...
        {
            ptr = mesh_icall_NodePath_Ctor(path);
        }
        ...
        {
            return mesh_icall_NodePath_operator_String(GetPtr(this));
        }
        ...
        {
            return new NodePath(mesh_icall_NodePath_get_as_property_path(GetPtr(this)));
        }
        ...
        {
            return mesh_icall_NodePath_get_concatenated_subnames(GetPtr(this));
        }
        ...
        {
            return mesh_icall_NodePath_get_name(GetPtr(this), idx);
        }
        ...
        {
            return mesh_icall_NodePath_get_name_count(GetPtr(this));
        }
        ...
        {
            return mesh_icall_NodePath_get_subname(GetPtr(this), idx);
        }
        ...
        {
            return mesh_icall_NodePath_get_subname_count(GetPtr(this));
        }
        ...
        {
            return mesh_icall_NodePath_is_absolute(GetPtr(this));
        }
        ...
        public bool IsEmpty()
        {
            return mesh_icall_NodePath_is_empty(GetPtr(this));
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern IntPtr mesh_icall_NodePath_Ctor(string path);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern void mesh_icall_NodePath_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string mesh_icall_NodePath_operator_String(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern IntPtr mesh_icall_NodePath_get_as_property_path(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string mesh_icall_NodePath_get_concatenated_subnames(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string mesh_icall_NodePath_get_name(IntPtr ptr, int arg1);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern int mesh_icall_NodePath_get_name_count(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string mesh_icall_NodePath_get_subname(IntPtr ptr, int arg1);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern int mesh_icall_NodePath_get_subname_count(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern bool mesh_icall_NodePath_is_absolute(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern bool mesh_icall_NodePath_is_empty(IntPtr ptr);
    }
}
