...
namespace Mesh
{
    ...
    public struct Callable
    {
        ...
        {
            return mesh_icall_Callable_Call(ref this, args);
        }
        ...
        {
            mesh_icall_Callable_CallDeferred(ref this, args);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object mesh_icall_Callable_Call(ref Callable callable, object[] args);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_Callable_CallDeferred(ref Callable callable, object[] args);
    }
}
