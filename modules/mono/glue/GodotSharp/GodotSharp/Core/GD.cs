...
namespace Mesh
{
    ...
    public static partial class GD
    {
        ...
        {
            return mesh_icall_GD_bytes2var(bytes, allowObjects);
        }
        ...
        {
            return mesh_icall_GD_convert(what, type);
        }
        ...
        {
            return mesh_icall_GD_instance_from_id(instanceId);
        }
        ...
        /// <summary>
        /// Pushes an error message to Mesh's built-in debugger and to the OS terminal.
        ///
        ...
        {
            mesh_icall_GD_pusherror(message);
        }

        /// <summary>
        /// Pushes a warning message to Mesh's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        ...
        {
            mesh_icall_GD_pushwarning(message);
        }
        ...
        {
            mesh_icall_GD_print(GetPrintParams(what));
        }
        ...
        {
            mesh_icall_GD_printerr(GetPrintParams(what));
        }
        ...
        ///
        /// Note: Due to limitations with Mesh's built-in console, this only prints to the terminal.
        ...
        {
            mesh_icall_GD_printraw(GetPrintParams(what));
        }
        ...
        {
            mesh_icall_GD_prints(GetPrintParams(what));
        }
        ...
        {
            mesh_icall_GD_printt(GetPrintParams(what));
        }
        ...
        {
            return mesh_icall_GD_randfn(mean, deviation);
        }
        ...
        {
            return mesh_icall_GD_randf_range(from, to);
        }
        ...
        {
            return mesh_icall_GD_randi_range(from, to);
        }
        ...
        {
            return mesh_icall_GD_rand_seed(seed, out seed);
        }
        ...
        /// <code>
        /// string a = "{\"a\": 1, \"b\": 2 }";
        /// var b = (Mesh.Collections.Dictionary)GD.Str2Var(a);
        ...
        {
            return mesh_icall_GD_str2var(str);
        }
        ...
        {
            return mesh_icall_GD_type_exists(StringName.GetPtr(type));
        }
        ...
        {
            return mesh_icall_GD_var2bytes(var, fullObjects);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Mesh.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        ...
        {
            return mesh_icall_GD_var2str(var);
        }
        ...
        {
            return mesh_icall_TypeToVariantType(type);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object mesh_icall_GD_bytes2var(byte[] bytes, bool allowObjects);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object mesh_icall_GD_convert(object what, Variant.Type type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int mesh_icall_GD_hash(object var);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern Object mesh_icall_GD_instance_from_id(ulong instanceId);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_print(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_printerr(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_printraw(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_prints(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_printt(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_randomize();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern uint mesh_icall_GD_randi();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern float mesh_icall_GD_randf();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int mesh_icall_GD_randi_range(int from, int to);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern double mesh_icall_GD_randf_range(double from, double to);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern double mesh_icall_GD_randfn(double mean, double deviation);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern uint mesh_icall_GD_rand_seed(ulong seed, out ulong newSeed);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_seed(ulong seed);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string mesh_icall_GD_str(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object mesh_icall_GD_str2var(string str);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool mesh_icall_GD_type_exists(IntPtr type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern byte[] mesh_icall_GD_var2bytes(object what, bool fullObjects);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string mesh_icall_GD_var2str(object var);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_pusherror(string type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_GD_pushwarning(string type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern Variant.Type mesh_icall_TypeToVariantType(Type type);
    }
}
