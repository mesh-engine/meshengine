...
namespace Mesh
{
    ...
    public sealed partial class RID : IDisposable
    {
        ...
        {
            this.ptr = mesh_icall_RID_Ctor(Object.GetPtr(from));
        }
        ...
        public int GetId()
        {
            return mesh_icall_RID_get_id(GetPtr(this));
        }
        ...
        internal static extern IntPtr mesh_icall_RID_Ctor(IntPtr from);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void mesh_icall_RID_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int mesh_icall_RID_get_id(IntPtr ptr);
    }
}
