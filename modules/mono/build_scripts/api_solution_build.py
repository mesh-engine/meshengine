...
def build_api_solution(source, target, env):
    ...
    solution_path = os.path.join(module_dir, "glue/MeshSharp/MeshSharp.sln")
    ...
    core_src_dir = os.path.abspath(os.path.join(solution_path, os.pardir, "MeshSharp", "bin", build_config))
    editor_src_dir = os.path.abspath(os.path.join(solution_path, os.pardir, "MeshSharpEditor", "bin", build_config))
...
def build(env_mono):
    ...
    for build_config in ["Debug", "Release"]:
        ...
        editor_api_dir = os.path.join(output_dir, "MeshSharp", "Api", build_config)
