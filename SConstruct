...
opts.Add(BoolVariable("tools", "Build the tools (a.k.a. the Mesh editor)", True))
...
opts.Add(BoolVariable("production", "Set defaults to build Mesh for use in production", False))
...
if selected_platform in ["linux", "bsd", "x11"]:
    if selected_platform == "x11":
        ...
        print('Platform "x11" has been renamed to "linuxbsd" in Mesh 4.0. Building for platform "linuxbsd".')
