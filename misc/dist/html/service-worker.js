...
const CACHE_VERSION = "@MESH_VERSION@";
const CACHE_NAME = "@MESH_NAME@-cache";
const OFFLINE_URL = "@MESH_OFFLINE_PAGE@";
// Files that will be cached on load.
const CACHED_FILES = @MESH_CACHE@;
// Files that we might not want the user to preload, and will only be cached on first load.
const CACHABLE_FILES = @MESH_OPT_CACHE@;
