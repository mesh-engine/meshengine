...
def configure(env):
    ...
    if env["android_arch"] == "x86":
        ...
        # The NDK adds this if targeting API < 21, so we can drop it when Mesh targets it at least
    ...
    env.Append(LINKFLAGS="-Wl,-soname,libmesh_android.so -Wl,--gc-sections".split())
