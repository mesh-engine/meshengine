...
// Note: Slightly modified to work better in Mesh.
...
// - Added a new parameter `ignore_y_` in the `Agent`. This parameter is used to control a mesh feature that allows to avoid collisions by moving on the horizontal plane.
namespace RVO {
/**
...
public:
    ...
    /// This is a mesh feature that allows the Agent to avoid collision by mooving
